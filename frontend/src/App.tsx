...
function App() {
	...
	const CheckUserAlreadyLoggedIn: React.FC<PropsWithChildren<{ children?: React.ReactNode }>> = ({
		children,
	}) => {
	...
	const ProtectedRoute: React.FC<PropsWithChildren<{ children?: React.ReactNode }>> = ({ children }) => {
