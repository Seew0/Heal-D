...
func (s *QuestionnaireService) GetQuestions(ctx context.Context) ([]models.Question, error) {
	return s.questionniarRepo.GetQuestions(ctx)
}

func (s *QuestionnaireService) GetQuestionByID(ctx context.Context, id string) (*models.Question, error) {
